    ...
    <div className="business-autonomy mb-5 rounded-2xl border border-slate-100 bg-slate-50/70 p-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="rounded-xl border border-slate-200 bg-white p-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-400">Canal</p>
          <p className="mt-1 text-xs font-medium text-slate-700">{autonomy.channel}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-400">SLA</p>
          <p className="mt-1 text-xs font-medium text-slate-700">{autonomy.sla}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-400">Complexidade</p>
          ...
          <p className="mt-1 text-xs font-medium text-slate-700">{autonomy.complexity}</p>
        </div>
      </div>
